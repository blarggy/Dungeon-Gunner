...
public class WeaponShootEffectSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("The color gradient for the shoot effect. This gradient shows the color of particles during their lifetime - from left to right")]
    #endregion Tooltip
    ...
    #region Tooltip
    [Tooltip("Start particle size for particle effect")]
    #endregion Tooltip
    ...
    #region Tooltip
    [Tooltip("Particle lifetime for the particle effect")]
    #endregion Tooltip
    public float startLifetime = 0.5f;
    #region Tooltip
    [Tooltip("The maximum number of particles that can be emitted")]
    #endregion Tooltip
    public int maxParticleNumber = 100;
    #region Tooltip
    [Tooltip("The rate at which the particles are emitted per second. If zero it will just be the burst number")]
    #endregion Tooltip
    public int emissionRate = 100;
    #region Tooltip
    [Tooltip("The number of particles to emit in a burst when the particle system is enabled")]
    #endregion Tooltip
    public int burstParticleNumber = 20;
    #region Tooltip
    [Tooltip("The gravity force of the particle effect, a small negative number will make them float upwards")]
    #endregion Tooltip
    public float effectGravity = -0.01f;
    #region Tooltip
    [Tooltip("The sprite to use for the particle effect - if none specified then the default particle sprite will be used")]
    #endregion Tooltip
